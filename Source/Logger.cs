    ...
    public class Logger
    {
        ...
        static Logger()
        {
            try
            {
                ...
                AssemblyName details = typeof(Logger).Assembly.GetName();
        ...
        {
            Logger.Error("Better Economy:" + "Intercepted exception (not game breaking):" + Environment.NewLine + $"{e.GetType()} - {e.Message}" + Environment.NewLine + e.StackTrace);
        }
